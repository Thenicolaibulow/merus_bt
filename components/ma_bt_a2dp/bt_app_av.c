...
static void bt_av_hdl_a2d_evt(uint16_t event, void *p_param)
{
    ...
    case ESP_A2D_CONNECTION_STATE_EVT:
    {
        ...
        {
            // If NVS_READ("remotebda..") != 0 { esp_a2d_sink_connect(remote_bda) }.. "Auto connect"
            // if (esp_a2d_sink_connect(remote_dba) Failed){    
        ...
        else if (a2d->conn_stat.state == ESP_A2D_CONNECTION_STATE_CONNECTED)
        {
            ...
            // NVS Write "remote_bda..", When connected, store the bda for future connection.
...
static void volume_set_by_controller(uint8_t volume)
{
    ...
    ma_write_byte(0x21,1,MA_vol_db_master__a,0x20+127-volume);
}
